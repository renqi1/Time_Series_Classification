...
# reposity: https://github.com/locuslab/TCN
...
# for classificaton
class TCN(nn.Module):
    def __init__(self, num_features, n_classes, channels: list, kernel_size=2, dropout=0.2):
        super(TCN, self).__init__()
        self.tcn = TemporalConvNet(num_features, channels, kernel_size=kernel_size, dropout=dropout)
        self.linear = nn.Linear(channels[-1], n_classes)
