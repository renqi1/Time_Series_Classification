...
class GRU_FCN(nn.Module):
    def __init__(self, Batch_Size, N_Features, N_ClassesOut, N_LSTM_Out=128, N_LSTM_layers=1,
        ...
        self.gru = nn.GRU(self.N_Features, self.N_LSTM_Out, self.N_LSTM_layers, batch_first=True)
    ...
    def init_hidden(self):
        h = torch.zeros(self.N_LSTM_layers, self.Batch_Size, self.N_LSTM_Out).cuda()
        return h
